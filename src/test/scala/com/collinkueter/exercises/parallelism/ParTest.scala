package com.collinkueter.exercises.parallelism

import java.util.concurrent.{ExecutorService, Executors}

import com.collinkueter.exercises.parallelism.Par._
import org.scalatest.BeforeAndAfterAll
import org.scalatest.flatspec.AnyFlatSpec
import org.scalatest.matchers.should.Matchers

class ParTest extends AnyFlatSpec with Matchers with BeforeAndAfterAll {
  val s: ExecutorService = Executors.newFixedThreadPool(20)
